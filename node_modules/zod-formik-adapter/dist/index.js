...
function createValidationError(e) {
    ...
    error.inner = e.issues.map(function (err) { return ({
        message: err.message,
        path: err.path.join("."),
    }); });
    return error;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, schema.parseAsync(obj, params)];
                        case 1:
                            _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
...
function toFormikValidate(schema, params) {
    ...
    return function (values) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, schema.safeParseAsync(values, params)];
                case 1:
                    result = _a.sent();
                    if (!result.success) {
                        return [2 /*return*/, createValidationResult(result.error)];
                    }
                    return [2 /*return*/];
            }
        });
