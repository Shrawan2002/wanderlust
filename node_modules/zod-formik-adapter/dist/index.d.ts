 ...
 */
export declare function toFormikValidationSchema<T>(schema: z.ZodSchema<T>, params?: Partial<core.ParseContext<core.$ZodIssue>>): {
 ...
 */
export declare function toFormikValidate<T>(schema: z.ZodSchema<T>, params?: Partial<core.ParseContext<core.$ZodIssue>>): (values: T) => Promise<Record<string, string> | undefined>;
